...
INSERT INTO `anuncios` (`titulo`, `provincia`, `ciudad`, `direccion`, `metros`, `habitaciones`, `banyos`, `renta`, `tipo`, `precio`,`fechaConstruccion`,`fechaPublicacion`) VALUES
('Se Vende Piso', 'Valencia', 'Ontinyent', 'Calle 123', 345, 4, 2, 'alquiler', 'piso', 785,'01/05/1995',now());