...
<body>
	...
	if(isset($_POST['grabar']) and $_POST['grabar'] == 'si'){
			...
			}else if(strlen($_POST['contrasenya']) < 2){
				$error[1] = '<span class="error">Mínimo 2 carácteres para el nombre</span>';
	...
	<form name="form" class="contacto" action="" method="post">
		...
		<div><label>Contraseña:</label><input type='text' name="contrasenya" class="contrasenya" value="<?php @$_POST['contrasenya'] ?>" ><?php echo @$error[1] ?></div>
