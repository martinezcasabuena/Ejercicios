...
jQuery.fn.LlenarLimpiarCampos = function(){
	this.each(function(){
		...
		$(".contrasenya").attr("value","Introduzca su contrasenya");
		$(".contrasenya").focus(function(){
			if($(".contrasenya").attr("value")=="Introduzca su contrasenya"){
			$(".contrasenya").attr("value","");		
			}
		});
		$(".contrasenya").blur(function(){
			if($(".contrasenya").attr("value")==""){
		   $(".contrasenya").attr("value","Introduzca su contrasenya");		
			}
		});
...
$(document).ready(function () {
    ...
    $(".boton").click(function(){
		...
		if( $(".nom").val() == "" || $(".nom").val() == "Introduzca su nombre"){
			...
			return false;
		}else if( $(".contrasenya").val() == "" || $(".contrasenya").val() == "Introduzca su contraseña"){
			$(".contrasenya").focus().after("<span class='error'>Ingrese una contraseña</span>");
			return false;
	...
	$(".nom, .asunto, .contrasenya, .mensaje").keyup(function(){
		if ( $(this).val() != "" ){
			$(".error").fadeOut();
			return false;
		}
